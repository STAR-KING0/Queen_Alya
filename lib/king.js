...
async function syncdb() {
  ...
  client.ev.on("call", async _0x522b10 => {
    let _0x37f540 = await callsg(client, JSON.parse(JSON.stringify(_0x522b10[0])));
  ...
  let groupData = {};
  let userData = {};
  client.ev.on("messages.upsert", async messagesUpsert => {
    try {
      if (!messagesUpsert.messages || !Array.isArray(messagesUpsert.messages)) {
        return;
      }
      botNumber = botNumber || client.decodeJid(client.user.id);
      for (mek of messagesUpsert.messages) {
        mek.message = Object.keys(mek.message || {})[0] === "ephemeralMessage" ? mek.message.ephemeralMessage.message : mek.message;
        if (!mek.message || !mek.key || !/broadcast/gi.test(mek.key.remoteJid)) {
          continue;
        }
        let _0x4857e4 = await smsg(client, JSON.parse(JSON.stringify(mek)), store, true);
  ...
  client.ev.on("messages.upsert", async messagesUpsert2 => {
    try {
      botNumber = botNumber || client.decodeJid(client.user.id);
      if (!global.isStart) {
        return;
      }
      for (mek of messagesUpsert2.messages) {
        if (!mek.message) {
          continue;
        }
        mek.message = Object.keys(mek.message || {})[0] === "ephemeralMessage" ? mek.message.ephemeralMessage.message : mek.message;
        ...
        let message = await smsg(client, JSON.parse(JSON.stringify(mek)), store, true);
        let _0x11d09c = message;
        ...
        var _0x36ea81 = message.isCreator;
        var _0x57832c = typeof message.text == "string" ? message.text.trim() : false;
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || message.isAstro && /2348039607375|2349027862116|2348052944641/g.test(botNumber) && _0x4186a0[0] == ",";
        ...
        if (_0x4dc849 && global.setCmdAlias[_0x4dc849] !== undefined) {
          ...
          _0x4dc849 = "sticker-" + message.msg.fileSha256;
        ...
        if (_0x9954f4 && (message.isBaileys || !_0x36ea81 && Config.WORKTYPE === "private" && !allowJid.includes(message.chat))) {
          _0x9954f4 = false;
        }
        const _0x34cf4e = message.body ? _0x4186a0.trim().split(/ +/).slice(1) : [];
        if (!_0x36ea81 && global.disablepm === "true" && _0x9954f4 && !message.isGroup) {
          _0x9954f4 = false;
        }
        if (!_0x36ea81 && global.disablegroup === "true" && _0x9954f4 && message.isGroup && !allowJid.includes(message.chat)) {
          _0x9954f4 = false;
        }
        Suhail.bot = client;
        if (_0x9954f4) {
          ...
          if (_0x111ae6 && _0x111ae6.fromMe && !message.fromMe && !_0x36ea81) {
            _0x111ae6 = false;
            return message.reply(tlang().owner);
          }
          if (message.isGroup && _0x111ae6 && _0x4931af !== "bot") {
            let _0x334235 = groupData[message.chat] || (await groupdb.findOne({
              id: message.chat
            })) || {
              botenable: toBool(message.isAstro || !blockJid.includes(message.chat))
            };
          ...
          if (!_0x36ea81 && _0x111ae6) {
            try {
              let _0x129db8 = userData[message.sender] || (await userdb.findOne({
                id: message.sender
              })) || {
                ban: "false"
              };
          ...
          if (_0x111ae6) {
            if (_0x111ae6.react) {
              message.react(_0x111ae6.react);
            }
            let _0x23f471 = message.body ? _0x4186a0.trim().split(/ +/).slice(1).join(" ") : "";
            let _0x2e97d6 = _0x111ae6.pattern;
            message.cmd = _0x2e97d6;
            try {
              _0x111ae6.function(message, _0x23f471, {
                cmd: _0x2e97d6,
                text: _0x23f471,
                body: _0x4186a0,
                args: _0x34cf4e,
        ...
        try {
          groupData[message.chat] = (await groupdb.findOne({
            id: message.chat
          })) || (await groupdb.new({
            id: message.chat,
            botenable: message.chat === "120363023983262391@g.us" ? "false" : "true",
            goodbye: toBool(global.gdbye),
            welcome: toBool(global.wlcm)
          }));
          userData[message.sender] = (await userdb.findOne({
            id: message.sender
          })) || (await userdb.new({
            id: message.sender,
        ...
        text = message.body;
        let _0x4717ae = {
          dbuser: userData[message.sender],
          dbgroup: groupData[message.chat],
          body: _0x4186a0,
          mek: mek,
          text: text,
          args: _0x34cf4e,
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            let _0x3078ae = !_0x2dffdb.fromMe || _0x2dffdb.fromMe && message.fromMe;
            if (_0x1d5795 === "main" && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            } else if (message.text && _0x1d5795 === "text" && /text|txt|true|smd|asta/gi.test(_0x2dffdb.quoted) && message.quoted && message.quoted.text && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            } else if (message.text && ["body", "text"].includes(_0x1d5795) && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            } else if (typeof message[_0x1421b9[_0x1d5795] || _0x1d5795] === "boolean" && message.quoted && message.quoted[_0x2dffdb.quoted] && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            } else if (_0x1d5795 === "viewonce" && (message.viewOnce || mek.message.viewOnceMessageV2)) {
              try {
                _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
              } catch (_0x1b9359) {
                console.log("[ERROR] ", _0x1b9359);
              }
            } else if (typeof message[_0x1421b9[_0x1d5795] || _0x1d5795] === "boolean" && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            }
            if (_0x1d5795 === "delete" && message.mtype == "protocolMessage" && message.msg.type === "REVOKE" && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            } else if (_0x1d5795 === "poll" && /poll/gi.test(message.mtype) && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            } else if (_0x1d5795 === "quoted" && message.quoted && _0x3078ae) {
              _0x2dffdb.function(message, _0x4186a0, _0x4717ae);
            }
          }
        });
  ...
  let _0x4c825a = {};
  client.ev.on("group-participants.update", async _0x33a505 => {
    try {
      let _0x1684d7 = await groupsg(client, JSON.parse(JSON.stringify(_0x33a505)), true);
  ...
  client.ev.on("groups.update", async _0x334a9c => {
    try {
  ...
  client.ev.on("groups.upsert", async _0x6ac529 => {
    try {
      ...
      await groupsg(client, JSON.parse(JSON.stringify(_0x6ac529[0])), false, true);
    } catch (_0x2ec500) {
      console.log(_0x2ec500);
    }
  });
  client.ev.on("contacts.upsert", _0x30754f => {
    try {
  ...
  client.ev.on("contacts.update", async _0x557445 => {
    for (let _0x2d3aad of _0x557445) {
      let _0x42cd7b = client.decodeJid(_0x2d3aad.id);
  ...
  client.serializeM = _0x40f3f1 => smsg(client, _0x40f3f1, store, false);
  client.ev.on("connection.update", async connectionUpdate => {
    const {
    ...
    if (_0x2224a7 === "open") {
      if (/true|ok|sure|yes/gi.test(global.flush) || !client.authState.creds?.myAppStateKeyId) {
        log("Flushing SESSION_ID" + (client.authState.creds?.myAppStateKeyId ? "" : " B'Coz *myAppStateKeyId Missing") + "!");
        client.ev.flush();
      }
      let _0x89b8f6 = client.decodeJid(client.user.id);
      ...
      let _0x1f88ec = 
`👑✨ ALL HAIL *${Config.botname}*! THE QUEEN HAS AWAKENED! ✨👑
...
🏰 *Database* : ${(isMongodb ? "💎 MongoDb" : sqldb ? "📚 PostgreSql" : "🌸 Alya Core")}
💫 _Royal Court_ 💫
...
🌟 *${Config.botname}* reigns supreme, ready to lead her kingdom! 🌟`;
      ...
      print(_0x1f88ec);
      await client.sendMessage(_0x89b8f6, {
        text: "```" + ("" + _0x1f88ec).trim() + "```"
      }, {
  ...
  client.getName = (_0x1e19e3, _0xbde05d = false) => {
    let _0x4bacff = client.decodeJid(_0x1e19e3);
    let _0x3a374f;
    ...
    if (_0x4bacff.endsWith("@g.us")) {
      return new Promise(async _0x49f5cb => {
        ...
        if (!_0x3a374f.name?.notify && !_0x3a374f.subject) {
          try {
            _0x3a374f = (await client.groupMetadata(_0x4bacff)) || {};
          } catch (_0xd44c16) {}
        }
      ...
      _0x3a374f = _0x4bacff === "0@s.whatsapp.net" ? {
        id: _0x4bacff,
        name: "WhatsApp"
      } : _0x4bacff === client.decodeJid(client.user.id) ? client.user : store.contacts[_0x4bacff] || {};
    }
  ...
  client.sendContact = async (_0xee3400, _0x1ba9aa, _0x460513 = "", _0x345014 = {}) => {
    let _0x3b10d0 = [];
    for (let _0x11d953 of _0x1ba9aa) {
      _0x3b10d0.push({
        displayName: await client.getName(_0x11d953 + "@s.whatsapp.net"),
        vcard: "BEGIN:VCARD\nVERSION:3.0\nN:" + (await client.getName(_0x11d953 + "@s.whatsapp.net")) + "\nFN:" + global.OwnerName + "\nitem1.TEL;waid=" + _0x11d953 + ":" + _0x11d953 + "\nitem1.X-ABLabel:Click here to chat\nitem2.EMAIL;type=INTERNET:" + global.email + "\nitem2.X-ABLabel:GitHub\nitem3.URL:" + global.github + "\nitem3.X-ABLabel:GitHub\nitem4.ADR:;;" + global.location + ";;;;\nitem4.X-ABLabel:Region\nEND:VCARD"
      });
    }
    return client.sendMessage(_0xee3400, {
      contacts: {
  ...
  client.messageId = (_0x344ea2 = 8, _0x4bb246 = "SUHAILMD") => {
  ...
  client.send5ButImg = async (_0x5014fe, _0x151c1b = "", _0x11eaa9 = "", _0x17f875, _0x1dc3ec = [], _0x148c68, _0x1b833a = {}) => {
    ...
    client.relayMessage(_0x5014fe, _0x35e5eb.message, {
      messageId: client.messageId()
    });
  };
  client.sendButtonText = (_0x32e16b, _0x2e98df = [], _0x268834, _0x5dadfc, _0x3d9e07 = "", _0x40db80 = {}) => {
    let _0x2d84f4 = {
      text: _0x268834,
      footer: _0x5dadfc,
      buttons: _0x2e98df,
    ...
    client.sendMessage(_0x32e16b, _0x2d84f4, {
      quoted: _0x3d9e07,
      ..._0x40db80
    });
  };
  client.sendText = (_0x1eade9, _0x1612ea, _0x57885f = "", _0x3dcc13) => client.sendMessage(_0x1eade9, {
    text: _0x1612ea,
    ..._0x3dcc13
  }, {
    quoted: _0x57885f
  });
  client.sendImage = async (_0x566754, _0x4723fa, _0x2087ca = "", _0x53d3a0 = "", _0x459604) => {
    ...
    return await client.sendMessage(_0x566754, {
      image: _0x3c11d8,
      caption: _0x2087ca,
      ..._0x459604
    }, {
  ...
  client.sendTextWithMentions = async (_0x54ea1e, _0x50c9ec, _0x2d2be2, _0x3a2080 = {}) => client.sendMessage(_0x54ea1e, {
    text: _0x50c9ec,
    contextInfo: {
  ...
  client.sendImageAsSticker = async (_0x3532c5, _0x527062, _0x3309ab = {}) => {
    let _0x262184;
    ...
    await client.sendMessage(_0x3532c5, {
      sticker: {
        url: _0x262184
      },
      ..._0x3309ab
  ...
  client.sendVideoAsSticker = async (_0x10f5a6, _0x5c502f, _0x587709 = {}) => {
    let _0x4c63fd;
    ...
    await client.sendMessage(_0x10f5a6, {
      sticker: {
        url: _0x4c63fd
      },
      ..._0x587709
  ...
  client.sendMedia = async (_0x2c82eb, _0x3b6f24, _0x1faf03 = "", _0x265eee = "", _0x43689c = "", _0x5f0c19 = {}) => {
    let _0x2a5dbc = await client.getFile(_0x3b6f24, true);
    let {
      mime: _0x50c8d4,
      ext: _0x249af9,
      res: _0x1d60dd,
    ...
    await client.sendMessage(_0x2c82eb, {
      [_0x4e01e4]: {
        url: _0xc5f634
      },
      caption: _0x265eee,
  ...
  client.downloadAndSaveMediaMessage = async (_0x23227c, _0x37efaf = "null", _0x3e6b5f = false, _0x2c905e = true) => {
  ...
  client.forward = async (_0x5d4b74, _0x57d8d8, _0x15b451, _0x16bd40, _0x25719f = true) => {
    try {
      ...
      if (_0x1c08a7 == "conversation") {
        ...
        for (let _0x696424 of parsedJid(_0x5d4b74)) {
          await client.sendMessage(_0x696424, _0x248698, {
            quoted: _0x16bd40,
            messageId: client.messageId()
          });
        }
      ...
      for (let _0x29179c of parsedJid(_0x5d4b74)) {
        try {
          await client.sendMessage(_0x29179c, _0x248698, {
            quoted: _0x16bd40,
            messageId: client.messageId()
          });
        } catch (_0x3b1e17) {}
  ...
  client.downloadMediaMessage = async _0x3d0953 => {
  ...
  client.forwardOrBroadCast2 = async (_0x2565bd, _0x442828, _0x145dd4 = {}, _0x23baf9 = "") => {
    try {
      ...
      await client.relayMessage(_0x2565bd, _0x5d8b14.message, {
        messageId: client.messageId()
      });
      return _0x5d8b14;
    } catch {}
  };
  client.forwardOrBroadCast = async (_0x189e5c, _0x54c0d9, _0x18e0cf = {}, _0x348d78 = "") => {
    try {
      if (!_0x18e0cf || typeof _0x18e0cf !== "object") {
        _0x18e0cf = {};
      }
      _0x18e0cf.messageId = _0x18e0cf.messageId || client.messageId();
      ...
      await client.relayMessage(_0x189e5c, _0xf31bf3.message, {
  ...
  client.copyNForward = async (_0x333b21, _0x4d04c0, _0x3c23fa = false, _0x4ed2c0 = {}) => {
    try {
      let _0x92cb9d;
      ...
      await client.relayMessage(_0x333b21, _0x3f7fe3.message, {
        messageId: client.messageId()
      });
      return _0x3f7fe3;
    } catch (_0x529a5c) {
  ...
  client.sendFileUrl = async (_0x245d2a, _0x1ddbcd, _0xd689ee = "", _0x2cf1f3 = "", _0x5b2d56 = {
    author: "Queen_Alya"
  }, _0x49581e = "") => {
    try {
      ...
      if (_0x5a6000) {
        try {
          return await client.sendMessage(_0x245d2a, _0x5a6000, {
            quoted: _0x2cf1f3
          });
        } catch {}
        ;
      ...
      try {
        ...
        if (_0x13eb84) {
          ...
          return await client.sendMessage(_0x245d2a, {
            document: {
              url: _0x1ddbcd
            },
            ..._0x47de2c
  ...
  const _0x29f5c5 = {};
  let _0x51034c = [];
  client.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
    let _0x28cdb7 = {};
    try {
      ...
      _0x28cdb7 = {
        ...(await client.contextInfo(Config.botname, _0x541cb3 && _0x541cb3.senderName ? _0x541cb3.senderName : Config.ownername, _0x28e991))
      };
      if (_0x237b02) {
        return await client.sendMessage(_0x264148, {
    ...
    try {
      ...
      return client.sendMessage(_0x264148, {
        text: _0x4d42ab.text || _0x4d42ab.caption,
        ..._0x4d42ab
      });
    }
  };
  client.contextInfo = async (_0x180918 = Config.botname, _0x4f8a10 = Config.ownername, _0x567995 = log0, _0x281a1c = 1, _0x3e314a = gurl, _0x1d19d2 = false) => {
    try {
  ...
  client.cMod = (_0x2fa8b5, _0x4510a5, _0xaaa44a = "", _0x2f32eb = client.user.id, _0x18c25b = {}) => {
    ...
    _0x4510a5.key.fromMe = _0x2f32eb === client.user.id;
    return proto.WebMessageInfo.fromObject(_0x4510a5);
  };
  client.getFile = async (_0x45942b, _0x80d77a) => {
    let _0x5bc7b0;
  ...
  client.sendFile = async (_0x17db4b, _0x2edb21, _0x347170, _0x1d60b2 = {
    quoted: ""
  }, _0x2b562b = {}) => {
    let _0x4285a2 = await client.getFile(_0x2edb21, true);
    let {
      filename: _0x479138,
      size: _0x527df9,
      ext: _0x14fc23,
    ...
    await client.sendMessage(_0x17db4b, {
      [_0x8dc65e]: {
        url: _0x1bcc52
      },
      mimetype: _0xb6648a,
  ...
  client.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ Suhail SER", _0x1a0d91 = {}) => {
  ...
  client.parseMention = async _0x3d4032 => {
    return [..._0x3d4032.matchAll(/@([0-9]{5,16}|0)/g)].map(_0x9e355e => _0x9e355e[1] + "@s.whatsapp.net");
  };
  app.get("/chat", (_0x52c0af, _0x203368) => {
    let _0x5785a4 = _0x52c0af.query.chat || _0x52c0af.query.jid || client.user.id || client.user.m || "";
    ...
    _0x5785a4 = client.decodeJid(_0x5785a4);
  ...
  client.awaitForMessage = async (_0x3f601c = {}) => {
    return new Promise((_0x42ef72, _0x15fbb5) => {
      ...
      let _0x4fedac = _0x54d8e0 => {
        ...
        if (_0x4bad66 == "notify") {
          for (let _0xa0c0c6 of _0x5bf6f0) {
            ...
            const _0x5447cd = client.decodeJid(_0x3f5f64 ? client.user.id : _0x36ea4b || _0x27529b ? _0xa0c0c6.key.participant : _0x43fd3f);
            if (_0x5447cd == _0x3f601c.sender && _0x43fd3f == _0x3f601c.remoteJid && _0x1919d8(_0xa0c0c6)) {
              client.ev.off("messages.upsert", _0x4fedac);
      ...
      client.ev.on("messages.upsert", _0x4fedac);
      if (_0x358393) {
...
<div class="bounce-text">Queen_Alya</div>
