...
async function syncdb() {
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2349066528353|2348100835767|17863688449/g.test(
        _0x89b8f6
      );
      let _0x506b6e = false;
...
let _0x1f88ec =
  "\n━━━━━━━━━━━━━━━\n" + 
  "✨ *QUEEN ALYA CONNECTED* ✨\n" + 
  "━━━━━━━━━━━━━━━\n" +
  "⚡ *Prefix*  : [ " + (prefix ? prefix : "null") + " ]\n" +
  "📦 *Plugins* : " + events.commands.length + "\n" +
  "🛠 *Mode*    : " + Config.WORKTYPE + "\n" +
  "💾 *Database*: " + 
  (isMongodb ? "MongoDB" : sqldb ? "PostgreSQL" : "QUEEN_ALYA") + "\n" +
  "━━━━━━━━━━━━━━━\n";
...
try {
  ...
  AstaConn.messageId = (length = 8, prefix = "QUEEN_ALYA") => {
...
app.listen(randomPort, () =>
  console.log(
    "QUEEN_ALYA Server listening on http://localhost:" + randomPort + "/ "
  )
);
