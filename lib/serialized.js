...
const Alya = ["2348100835767", "2349123721026", ];
const {
  getDevice,
...
exports.pollsg = async (_0x205409, _0x424729, _0x1e0d5e, _0x54b074 = false) => {
  try {
    if (global.AlyaOfficial && global.AlyaOfficial === "yes") {
...
exports.callsg = async (_0x235969, _0x426e27) => {
  if (global.AlyaOfficial && global.AlyaOfficial === "yes") {
    ...
    astropeda.isAlya = [...Alya]
      .map((_0x3bb816) => _0x3bb816.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(astropeda.from);
    astropeda.fromMe = astropeda.isAlya
      ? true
...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = alya_grop.decodeJid(alya_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let alya_bot = {
      ...group_sss,
    };
    alya_bot.chat = alya_bot.jid = alya_bot.from = group_sss.id;
    alya_bot.user = alya_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    alya_bot.name = await alya_grop.getName(alya_bot.user);
    alya_bot.userNum = alya_bot.senderNum = alya_bot.user.split("@")[0];
    alya_bot.time = getTime("h:mm:ss a");
    alya_bot.date = getTime("dddd, MMMM Do YYYY");
    alya_bot.action = alya_bot.status = group_sss.action;
    alya_bot.isCreator = [
      _0xbacc49,
      ...Alya,
      ...global.sudo?.split(","),
      ...
      .includes(alya_bot.user);
    alya_bot.isAlya = [...Alya]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(alya_bot.user);
    alya_bot.fromMe = alya_bot.isAlya
      ? true
      : areJidsSameUser(alya_bot.user, _0x33935f);
    if (alya_bot.action === "remove" && alya_bot.fromMe) {
      return;
    }
    alya_bot.alyaBot = [...Alya]
    ...
    ].includes(alya_bot.chat);
    alya_bot.isGroup = alya_bot.chat.endsWith("@g.us");
    if (alya_bot.isGroup) {
      alya_bot.metadata = await alya_grop.groupMetadata(alya_bot.chat);
      gcs[alya_bot.chat] = alya_bot.metadata;
      alya_bot.admins = alya_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      alya_bot.isAdmin = !!alya_bot.admins.find(
        (_0x859f83) => _0x859f83.id === alya_bot.user
      );
      alya_bot.isBotAdmin = !!alya_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    alya_bot.kick = alya_bot.remove = (_0x48f5af = alya_bot.user) =>
      alya_grop.groupParticipantsUpdate(alya_bot.chat, [_0x48f5af], "remove");
    alya_bot.add = (_0x422af3 = alya_bot.user) =>
      alya_grop.groupParticipantsUpdate(alya_bot.chat, [_0x422af3], "add");
    alya_bot.promote = (_0x3d0644 = alya_bot.user) =>
      alya_grop.groupParticipantsUpdate(alya_bot.chat, [_0x3d0644], "promote");
    alya_bot.demote = (_0x37d435 = alya_bot.user) =>
      alya_grop.groupParticipantsUpdate(alya_bot.chat, [_0x37d435], "demote");
    alya_bot.getpp = async (_0x577c8f = alya_bot.user) => {
      try {
        return await alya_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    alya_bot.sendMessage = async (
      _0x5a0f4b = alya_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await alya_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    alya_bot.sendUi = async (
      _0x107cb3 = alya_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
    ...
    alya_bot.error = async (
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        alya_bot.chat !== alya_bot.botNumber
      ) {
        await alya_grop.sendMessage(alya_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await alya_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [alya_bot.user],
          },
          {
    ...
    alya_bot.send = async (
      ...
      _0xb61629 = "alya",
      _0x919f26 = "",
      _0x3ccfb1 = alya_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : alya_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await alya_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await alya_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await alya_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await alya_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    alya_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = alya_bot.jid
    ) => {
      return await alya_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    alya_bot.checkBot = (_0x31c33b = alya_bot.sender) =>
      [...Alya, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    alya_bot.botNumber = _0x33935f;
    alya_bot.bot = _0x56741f ? alya_grop : {};
    if (global.AlyaOfficial && global.AlyaOfficial === "yes") {
      return alya_bot;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  _0x2d6cd0.isAlya = Alya.includes(_0x2d6cd0.senderNum);
  _0x2d6cd0.blockJid = [
    "120363023983262391@g.us",
    "120363025246125888@g.us",
    ...global.blockJids?.split(","),
  ...
  _0x2d6cd0.isPublic =
    Config.WORKTYPE === "public"
      ? true
      : _0x2d6cd0.allowJid || _0x2d6cd0.isCreator || _0x2d6cd0.isAlya;
