...
smd({
  ...
  try {
    let _0x5cdb67 = _0x2c2791.split(" ")[0x0].toLowerCase().trim();
    ...
    if (_0x5cdb67 == "all" || _0x5cdb67 === "global") {
      ...
      if (_0x5cdb67.startsWith('on') || _0x5cdb67.startsWith('act') || _0x5cdb67.startsWith('enable')) {
        ...
        if (_0x5cdb67.startsWith("off") || _0x5cdb67.startsWith('deact') || _0x5cdb67.startsWith("disable")) {
...
smd({
  ...
  try {
    ...
    if (_0x46a6d4.isCreator) {
      _0x4fb093 = _0x46a6d4.reply_message ? _0x46a6d4.reply_message.sender : _0x46a6d4.mentionedJid[0x0] ? _0x46a6d4.mentionedJid[0x0] : _0x4fb093;
    }
...
smd({
  ...
  try {
    ...
    let _0x57e33b = parseInt(Config.warncount) || 0x3;
    if (_0x15bf3a[_0x302c94.chat].length > _0x57e33b && !_0x302c94.checkBot(_0x4ea22b)) {
      if (_0x302c94.isGroup) {
        if (_0x302c94.isBotAdmin) {
          await _0x302c94.send("*_Hey @" + _0x4ea22b.split('@')[0x0] + ", Kicking you from group!_*\n*_Because Your warn limit exceed!_*", {
            'mentions': [_0x4ea22b]
          });
          await _0x302c94.bot.groupParticipantsUpdate(_0x302c94.chat, [_0x4ea22b], "remove");
        } else {
          return await _0x302c94.send("*_Hey @" + _0x4ea22b.split('@')[0x0] + " Dont Spam, Your warn limit exceed!_*");
        }
      } else {
        await _0x302c94.send("*_Hey @" + _0x4ea22b.split('@')[0x0] + ", Blocking you!_*\n*_Because Your warn limit exceed!_*", {
          'mentions': [_0x4ea22b]
        });
...
smd({
  ...
  try {
    ...
    let _0x1a359b = _0x280072.reply_message ? _0x280072.reply_message.sender : _0x280072.mentionedJid[0x0] ? _0x280072.mentionedJid[0x0] : false;
    if (!_0x1a359b) {
...
smd({
  ...
  try {
    ...
    let _0x3bfdde = _0x4a2b18?.["split"](" ")[0x0]["toLowerCase"]()?.['trim']() || false;
...
smd({
  ...
  try {
    ...
    let _0x512c3d = _0x33a14d?.["split"](" ")[0x0]['toLowerCase']()?.["trim"]() || false;
    if (!_0x512c3d) {
...
smd({
  ...
  try {
    ...
    let _0x277eb9 = _0x3a4d1c ? _0x3a4d1c.split(" ")[0x0] : false;
    ...
    if (!_0x277eb9) {
      ...
      if (_0x277eb9.startsWith("off") || _0x277eb9.startsWith("deact") || _0x277eb9.startsWith("disable")) {
        ...
        if (_0x277eb9.startsWith('on') || _0x277eb9.startsWith("act") || _0x277eb9.startsWith("enable")) {
...
smd({
  ...
  try {
    ...
    let _0x51b908 = _0x554fdc ? _0x554fdc.split(" ")[0x0] : false;
    ...
    if (!_0x51b908) {
      ...
      if (_0x51b908.startsWith('off') || _0x51b908.startsWith('deact') || _0x51b908.startsWith('disable')) {
        ...
        if (_0x51b908.startsWith('on') || _0x51b908.startsWith("act") || _0x51b908.startsWith('enable')) {
...
smd({
  ...
  try {
    ...
    let _0x3c4e49 = _0x24b1ea ? _0x24b1ea.split(" ")[0x0] : false;
    ...
    if (!_0x3c4e49) {
      ...
      if (_0x3c4e49.startsWith("off") || _0x3c4e49.startsWith('deact') || _0x3c4e49.startsWith("disable")) {
        ...
        if (_0x3c4e49.startsWith("kick")) {
          ...
          if (_0x3c4e49.startsWith("delete")) {
...
smd({
  ...
  try {
    ...
    let _0x5dfd01 = _0x3005a8 ? _0x3005a8.split(" ")[0x0] : false;
    if (!_0x5dfd01) {
      ...
      if (_0x5dfd01.startsWith('off') || _0x5dfd01.startsWith("deact") || _0x5dfd01.startsWith("disable")) {
        ...
        if (_0x5dfd01.startsWith('on') || _0x5dfd01.startsWith("act") || _0x5dfd01.startsWith("enable")) {
  ...
  try {
    ...
    if (!_0x21d881) {
      ...
      if (_0x21d881 === "false") {
        ...
        if (_0x21d881 === 'warn' || _0x21d881 === "kick") {
...
smd({
  ...
  try {
    ...
    let _0x39d4ba = _0x2c683c ? _0x2c683c.split(" ")[0x0] : '';
    if (!_0x39d4ba) {
      return await _0x57fd77.send("*Provide cmd name to disable in group*\n*Ex " + prefix + "disable tag(to disabled 'tag' cmd)/info*");
    } else {
      if (_0x39d4ba.startsWith("info") || _0x39d4ba.startsWith("list") || _0x39d4ba.startsWith("cmds")) {
        ...
        if (_0x39d4ba.startsWith("enable") || _0x39d4ba.startsWith('disable') || _0x39d4ba.startsWith("bot")) {
...
smd({
  ...
  try {
    ...
    let _0x7e021e = _0x51a36d ? _0x51a36d.split(" ")[0x0] : '';
    ...
    if (!_0x7e021e || _0x7e021e === '') {
      ...
      if (_0x51a36d.startsWith("all")) {
        ...
        if (_0x1e30cd.test(_0x2a73ae.disablecmds) && _0x2a73ae.disablecmds.includes(_0x7e021e)) {
...
smd({
  ...
  try {
    ...
    if (_0x35dcf2.startsWith('on') || _0x35dcf2.startsWith("act") || _0x35dcf2.startsWith("enable")) {
      ...
      if (_0x35dcf2.startsWith('off') || _0x35dcf2.startsWith("deact") || _0x35dcf2.startsWith("disable")) {
...
smd({
  ...
  try {
    ...
    if (_0x4fe583.startsWith('on') || _0x4fe583.startsWith("act") || _0x4fe583.startsWith("enable")) {
      ...
      if (_0x4fe583.startsWith("off") || _0x4fe583.startsWith("deact") || _0x4fe583.startsWith("disable")) {
...
smd({
  ...
  try {
    ...
    if (_0x3c651a.startsWith('on') || _0x3c651a.startsWith("act") || _0x3c651a.startsWith("enable")) {
      ...
      if (_0x3c651a.startsWith("off") || _0x3c651a.startsWith("deact") || _0x3c651a.startsWith('disable')) {
...
smd({
  ...
  try {
    ...
    if (isNaN(_0x159db4) || isNaN(_0x1b2477) || _0x159db4 < 0x0 || _0x159db4 >= 0x18 || _0x1b2477 < 0x0 || _0x1b2477 >= 0x3c) {
      return _0x40a933.reply("Please provide correct form.\nEg: " + prefix + "amute 22:00");
    }
    let _0x223929 = _0x159db4.toString().padStart(0x2, '0') + ':' + _0x1b2477.toString().padStart(0x2, '0');
    await groupdb.updateOne({
      'id': _0x40a933.chat
    }, {
      'mute': _0x223929
...
smd({
  ...
  try {
    ...
    if (isNaN(_0x405a82) || isNaN(_0x2e7bff) || _0x405a82 < 0x0 || _0x405a82 >= 0x18 || _0x2e7bff < 0x0 || _0x2e7bff >= 0x3c) {
      return _0x20f896.reply("Please provide correct form.\nEg: " + prefix + "aunmute 22:00");
    }
    let _0x3074bb = _0x405a82.toString().padStart(0x2, '0') + ':' + _0x2e7bff.toString().padStart(0x2, '0');
    await groupdb.updateOne({
      'id': _0x20f896.chat
    }, {
      'unmute': _0x3074bb
...
async function haveEqualMembers(_0x4299c5, _0x36f2ca) {
  if (_0x4299c5.length === 0x0 || _0x36f2ca.length === 0x0) {
    return false;
  }
  const _0x4b02b5 = _0x4299c5.filter(_0x390823 => _0x36f2ca.includes(_0x390823));
  const _0x4efcfe = _0x4b02b5.length / _0x4299c5.length * 0x64;
  return _0x4efcfe >= 0x50;
}
smd({
  'pattern': 'antiword',
  ...
  try {
    ...
    let _0x4aeb18 = _0x23a35d.split('|')[0x1] || '';
    ...
    if (_0x5c8c79 === 'reset') {
      ...
      if (_0x5c8c79 === 'delete' || _0x5c8c79 === "warn") {
  ...
  try {
    ...
    try {
      ...
      if (_0x5305a4 && _0x39d1ac.isGroup && !_0x39d1ac.isAdmin && !_0x3447c7 && _0x39d1ac.mtype !== "reactionMessage" && _0x5305a4.botenable == "true") {
        ...
        if (_0x5305a4.onlyadmin && _0x5305a4.onlyadmin === "true" && AstroOfficial == "yes") {
          var _0x5b1bba = '';
          if (_0x39d1ac.isBotAdmin) {
            let _0x423964 = {
        ...
        if (_0x5305a4.antilink && _0x5305a4.antilink !== "false" && AstroOfficial === "yes") {
    ...
    if (_0x22b59e.length > 0x1 && !_0x39d1ac.isBot && _0xe8d652 && _0xe8d652.status !== "false" && _0xe8d652.words) {
      var _0x27bcfa = _0xe8d652.words.split(',') || [];
      let _0x441ee8 = false;
      _0x27bcfa.map(async _0x55e61d => {
        if (_0x39d1ac.isAdmin || !global.AstroOfficial || global.AstroOfficial != "yes") {
          return;
        }
    ...
    if (_0x51e325) {
      let _0x55d8b7 = parseInt(Config.warncount) || 0x3;
    ...
    try {
      if (!global.AstroOfficial || _0x39d1ac.mtype == "reactionMessage") {
        return;
      }
      ...
      if (_0x180c43 === "true" && !_0x22254d && !_0x39d1ac.isBot && _0x39d1ac.text) {
        let _0x274bb7 = !_0x39d1ac.isGroup ? _0x39d1ac.user : _0x39d1ac.quoted ? _0x39d1ac.quoted.sender : _0x39d1ac.mentionedJid[0x0] || false;
...
smd({
  ...
  try {
    ...
    if (_0x5d4655.antipromote == "true" && !_0x5dad3d.isCreator) {
      _0x468228 = !_0x5dad3d.isBotAdmin;
      ...
      if (_0x5dad3d.isBotAdmin) {
        try {
          ...
          if (user_warns[_0x5dad3d.sender][_0x5dad3d.action] > 0x2) {
            return;
          }
...
smd({
  ...
  try {
    ...
    if (_0x47cda5.antidemote == "true" && !_0x28f5ec.isCreator) {
      _0x48cf93 = !_0x28f5ec.isBotAdmin;
