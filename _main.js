...
async function aiResponce(_0x109acf, _0xf00650, _0x2728a0 = "") {
  ...
  try {
    if (_0xf00650 === _0x242f00(243)) {
      ...
      const _0x3e1043 = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        headers: {
          ...
          Authorization: "Bearer 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"
        },
        body: JSON.stringify({
          model: "gpt-3.5-turbo",
          messages: [{
      ...
      if (!_0x26c61c.choices || _0x26c61c.choices.length === 0) {
        _0x2d78d9 = "*Invalid ChatGPT API Key, Please Put New Key*";
      } else {
        _0x2d78d9 = _0x26c61c.choices[0].message.content;
      }
      ...
      _0x2d78d9 = _0x2cdadf.data[0].url;
    }
    if (_0xf00650 === "rmbg") {
      const _0x142226 = {
        image_url: _0x2728a0,
      ...
      axios.post(_0x242f00(263), _0x142226, {
        ...
        _0x2d78d9 = Buffer.from(_0x18f9bd.data, _0x382416(259));
      }).catch(_0x25d8c1 => {
        _0x2d78d9 = false;
      });
    }
    ...
    console.error("error in aiResponce : ", _0x4eee67);
...
smd({
  ...
  use: "2348100xxxx,Your_text_here",
  fromMe: true,
  filename: __filename
